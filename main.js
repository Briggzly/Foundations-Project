...
displayIcon = () => {
  if (dateAnswer.textContent === "Bowling") {
    ...
    activityIcon.src =
      "https://cdn-icons-png.flaticon.com/512/2017/2017204.png";
    activityIcon.style.display = "block";
  } else if (dateAnswer.textContent === "Swimming") {
    activityIcon.src =
      "https://cdn-icons-png.flaticon.com/512/3412/3412879.png";
    activityIcon.style.display = "block";
    ...
    activityIcon.src =
      "https://cdn-icons-png.flaticon.com/512/2782/2782377.png";
    activityIcon.style.display = "block";
    ...
    activityIcon.src =
      "https://cdn-icons-png.flaticon.com/512/1539/1539701.png";
    activityIcon.style.display = "block";
    ...
    activityIcon.src =
      "https://cdn-icons-png.flaticon.com/512/3077/3077188.png";
    activityIcon.style.display = "block";
  } else if (dateAnswer.textContent === "Concert") {
    activityIcon.src =
      "https://cdn-icons-png.flaticon.com/512/2394/2394757.png";
    activityIcon.style.display = "block";
  }
};
...
nearMe = () => {
  if (dateAnswer.textContent === "Bowling") {
    ...
    nearMeLink.href =
      "https://www.google.com/search?q=pools+near+me&oq=pools+near+me";
  } else if (dateAnswer.textContent === "Camping") {
